    ...
    <div className='relative z-[10] flex items-center h-[100%] text-white'>
        <div className='w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[2rem]'>
            ...
            <div>
                ...
                <h1 className='text-[25px] sm:text-[32px] md:text-[38px] lg:text-[45px] text-white leading-[2rem] md:leading-[3.5rem] font-medium'>THE WORLD CUP 2026 WHAT ARE THE EXCITING NEWS FOR US</h1>
                ...
                <div className='mt-[2.4rem] flex items-center space-x-6'>
                    <button className='sm:px-8 sm:py-2.5 px-4 py-2 bg-red-600 hover:bg-red-800 transition-all duration-200 sm:text-[17px] text-[13] font-semibold text-white'>Watch Highlights</button>
                    <button className='sm:px-8 sm:py-2.5 px-4 py-2 bg-white hover:bg-gray-300 transition-all duration-200 sm:text-[17px] text-[13] font-semibold text-black'>Learn More</button>
                </div>
            </div>
            {/* play button */}
            <div>
