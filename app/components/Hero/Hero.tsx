    ...
    <div className='relative z-[10] flex items-center h-[100%] text-white'>
        <div className='w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[2rem]'>
            ...
            <div>
                ...
                <h1 data-aos="fade-right" data-aos-delay="200" className='text-[25px] sm:text-[32px] md:text-[38px] lg:text-[45px] text-white leading-[2rem] md:leading-[3.5rem] font-medium'>BIG TEAMS WIN BIG GAMES</h1>
